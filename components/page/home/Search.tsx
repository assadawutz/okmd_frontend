...
export default function OkmdSearchSection() {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      setSearchResults([
        {
          title: "แนวโน้มอาชีพในปี 2025",
          text: "การวิเคราะห์แนวโน้มตลาดแรงงานและทักษะที่จำเป็นสำหรับอนาคต..."
        },
        {
          title: "ทักษะที่จำเป็นสำหรับยุค AI",
          text: "รวบรวมทักษะสำคัญที่มนุษย์ต้องมีเพื่อทำงานร่วมกับปัญญาประดิษฐ์..."
        }
      ]);
    }, 1500);
  };
    ...
    <section className="bg-white py-16 md:py-20">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          {/* -------------------------------------------------------------- */}
          {hasSearched && (
            <div className="mt-12 md:mt-16 animate-fadeIn text-left w-full">
