...
export default function OkmdSearchSection() {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      setSearchResults([
        {
          title: "แนวโน้มอาชีพในปี 2025: ทักษะที่ตลาดแรงงานต้องการ",
          text: "ในปี 2025 ตลาดแรงงานจะต้องการทักษะด้านเทคโนโลยีสารสนเทศ การวิเคราะห์ข้อมูล และความสามารถในการปรับตัว..."
        },
        {
          title: "การพัฒนาทักษะ Soft Skills เพื่อความสำเร็จในยุคดิจิทัล",
          text: "Soft Skills เช่น การสื่อสาร การทำงานร่วมกัน และการคิดเชิงวิพากษ์ จะเป็นกุญแจสำคัญในการทำงานร่วมกับ AI..."
        },
        {
          title: "การเรียนรู้ตลอดชีวิต (Lifelong Learning) กับการเปลี่ยนแปลงของโลก",
          text: "การเรียนรู้ไม่หยุดนิ่งเป็นสิ่งจำเป็นในยุคที่เทคโนโลยีเปลี่ยนแปลงเร็ว การ Upskill และ Reskill จะช่วยให้คุณ..."
        }
      ]);
    ...
    <section className="bg-white py-12 md:py-16">
      <div className="container mx-auto px-6 lg:px-10">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          {/* -------------------------------------------------------------- */}
          {hasSearched && (
            <div className="mt-12 md:mt-16 animate-fadeIn w-full text-left">
